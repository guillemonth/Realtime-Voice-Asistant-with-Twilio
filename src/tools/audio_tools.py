...
from src.constants.general_constants import constants as constans
...
async def pcm24k_to_ulaw8k(buffer: bytes) -> bytes:
    ...
    Returns:
        bytes: Converted audio bytes
    """
    pcm_8k, _ = audioop.ratecv(buffer, 2, 1, g_constants.GEMINI_OUTPUT_RATE, constans.TWILIO_OUTPUT_RATE, None)
